...
<body>
    <p align="right" style="position:fixed;left:1300px;top:10px;">
    ...
    <button onclick="history.go(-1)" style="background-color:black;"><a style="color:aqua;margin:20;">Exit
            Quiz</a></button>
    <?php
    ...
    echo '<form method="post" style="margin:20;top:10px;" action="quizverify.php?category='.$category.'">';
    for ($i = 0; $i < 10; $i++) {
