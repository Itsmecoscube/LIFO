...
<body>
    <div class="nav">
        ...
        <div class="profile">
        <img  align="right" src="../images/avatar.png" style="width:180px;position:fixed;left:1350px;top:80px;">
                ...
                <div class="bottom">
                        ...
                        <div class="tabsection">
                            <div class="tabs">
                                ...
                                <a href="../quiz.php?category=11"><button class="tablinks" style="background-color: yellow; color:black;font-weight: 500;">Start Quiz</button></a>
                            </div>
                        </div>
                        ...
                        <div class="descriptionsection">
                            ...
                            <div id="filmquiz" class="tabcontent">
                                <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Nihil, fuga.</p>
                            </div>
                        </div>
                </div>
