        ...
        <div class="content">
            ...
            <div class="boxx">
                <div class="top bg-[url(../images/img2.jpg)]">
                    <div class="title">Techfin Galaxy</div>
                </div>
                <div class="bottom">
                        ...
                        <div class="tabsection">
                            <div class="tabs">
                                ...
                                <a href="../quiz.php?category=30"><button class="tablinks" style="background-color: yellow; color:black;font-weight: 500;">Start Quiz</button></a>
                            </div>
                        </div>
